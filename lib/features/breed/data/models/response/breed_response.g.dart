...
BreedWeight _$BreedWeightFromJson(Map<String, dynamic> json) => BreedWeight(
      imperial: json['imperial'] as String,
      metric: json['metric'] as String,
    );

Map<String, dynamic> _$BreedWeightToJson(BreedWeight instance) =>
    <String, dynamic>{
...
BreedResponse _$BreedResponseFromJson(Map<String, dynamic> json) =>
    BreedResponse(
      weight: BreedWeight.fromJson(json['weight'] as Map<String, dynamic>),
      id: json['id'] as String,
